...
const Services = () => {
    const services =[
        ...
        },
        {
            ...
            description:"Collaboratively leverage other's an quality bandwidth through covalent theme value. Appropriately coordinate.",
            icon:"https://cdn-icons-png.freepik.com/256/6047/6047236.png?uid=R167929721&ga=GA1.1.1538646131.1728666203&semt=ais_incoming"
        },
        {
            id: 6,
            title:"photography",
            description:"Collaboratively leverage other's an quality bandwidth through covalent theme value. Appropriately coordinate.",
            icon:"https://cdn-icons-png.freepik.com/256/349/349534.png?uid=R167929721&ga=GA1.1.1538646131.1728666203&semt=ais_incoming"
        },
    ]
  return (
